...
class UserData:
    ...
    @staticmethod
    def validate_actual_name(*names):
        name_error = 0
        for name in names:
    ...
    def validate_uname(username):
            with open("c:/Users/User/MyProject/userdata2.txt", 'r') as datafile:
                global registering
    ...
    @staticmethod
    def validate_data(username, email, password1, password2, firstname, lastname): # validating all the input
    ...
    def storing_data_to_file(username, email, password1, password2, firstname, lastname):
        if validated_data:
            global store_count
            global salt
            with open("c:/Users/User/MyProject/userdata2.txt", 'a+') as datafile:
...
class UserLogin():
    ...
    def validate_password(username, pwd):
        global salt
        with open(f"c:/Users/User/MyProject/userdata2.txt", 'r') as user_hash:
...
def view_data():
    ...
    firstnames = []
    lastnames = []
    with open("c:/Users/User/MyProject/userdata2.txt", 'r') as user_data:
...
def delete_users_by_name():
    ...
    with open("c:/Users/User/MyProject/userdata2.txt", 'r') as user_data:
        ...
        # print(line_number)
    if positive:
        with open("c:/Users/User/MyProject/userdata2.txt", 'w') as user_data:
...
def user_search():
    ...
    with open("c:/Users/User/MyProject/userdata2.txt", 'r') as user_data:
        ...
        for number, data in enumerate(data_list):
            word_fix = data.split('\t')
            # print(word_fix)
            if user_to_find in word_fix[0].strip('\n'):
                # print("woohoo")
                line_number = number
                positive = True
    if positive:
...
if __name__ == '__main__':
    ...
    email_char = "@"
    store_count = 0
    options = ["Add an entry", "View the data", "Remove an entry", "Search a user"] # TODO: Removing function is still yet to be implemented
    ...
    def show_menu():
        ...
        switcher(u_input) #************** calling the argument according the the user input***************
        # start_script()
